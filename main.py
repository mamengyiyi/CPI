...
if __name__ == "__main__":
    ...
    # Experiment
    parser.add_argument("--policy", default="CPI")  # Policy name
    ...
    # TD3 + BC
    parser.add_argument("--qweight", default=1.0, type=float)  # tau in the paper can be understood as the reciprocal of alpha in TD3+BC
    parser.add_argument("--aweight", default=0.5, type=float, help='The weighting coefficient')  # lambda in the paper
    ...
    # Initialize policy
    policy = CPI.CPI(**kwargs)
    # policy = CPI_RE.CPI_RE(**kwargs)
